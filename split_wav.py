...
def parse_args():
    ...
    parser.add_argument("--segment_seconds", type=int, default=5, required=False, help="duration in seconds of splitted wave segment")
    parser.add_argument("--multi_speakers", type=int, default=1, help="multiple speakers mode or one speaker mode")
    parser.add_argument("--speaker_id",  type=int, default=None, required=False, help="speaker id to make a directory that contains all splitted waves. valid only when multi_speakers equals 0")
